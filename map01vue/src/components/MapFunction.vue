  ...
  <div class="container">
    <div class="main-content">
      ...
      <div class="mode-selection">
        <button :class="{ active: currentMode === 'input' }" @click="setCurrentMode('input')">匯入</button>
        <button :class="{ active: currentMode === 'output' }" @click="setCurrentMode('output')">匯出</button>
      </div>
